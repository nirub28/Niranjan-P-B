{
        ...
        newPostForm.submit(function(e){
            ...
            $.ajax({
                ...
                success:function(data){
                    ...
                    //enable functinality of toggle like button on new post
    ...
    <p>
                ...
                <br>
                <small>
                      <a class="toggle-like-buttton" data-likes="0" href="/likes/toggle/?id=${post._id}&type=Post">
                            0Likes
                      </a>
              </small>
    ...
    let deletePost = function(deleteLink){
        ...
        // loop over all the existing posts on the page (when the window loads for the first time) and call the delete post 
